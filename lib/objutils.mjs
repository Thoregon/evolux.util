...
export const isObject    = (obj) => !isString(obj) && !isNumber(obj) && !isSymbol(obj) && !isBigint(obj) && !isBoolean(obj) && !isFunction(obj) && !isPromise(obj) && !isUndefined(obj);
...
export const isRef       = (obj) => !isNil(obj) && typeof obj === 'object'; // this includes also arrays
...
if (!Array.prototype.toObject) Object.defineProperty(Array.prototype, 'toObject', {
    configurable: false,
    enumerable: false,
    // writable: false,
...
if (!Array.prototype.toEnum) Object.defineProperty(Array.prototype, 'toEnum', {
    configurable: false,
    enumerable: false,
    // writable: false,
...
if (!Array.prototype.asyncForEach) Object.defineProperty(Array.prototype, 'asyncForEach', {
    configurable: false,
    enumerable: false,
    // writable: false,
...
if (!Array.prototype.asyncFind) Object.defineProperty(Array.prototype, 'asyncFind', {
    configurable: false,
    enumerable: false,
    // writable: false,
