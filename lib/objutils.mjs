...
if (!Array.prototype.hasOwnProperty('forEachAsync')) Object.defineProperty(Array.prototype, 'forEachAsync', {
    configurable: false,
    enumerable: false,
    // writable: false,
    value: async function forEachAsync(fn) {
        await Promise.all(this.map(fn));
    }

})

if (!Array.prototype.hasOwnProperty('mapAsync')) Object.defineProperty(Array.prototype, 'mapAsync', {
    configurable: false,
    enumerable: false,
    // writable: false,
    value: async function mapAsync(mapFn) {
        return Promise.all(this.map(mapFn));
    }
})

if (!Array.prototype.hasOwnProperty('filterAsync')) Object.defineProperty(Array.prototype, 'filterAsync', {
    configurable: false,
    enumerable: false,
    // writable: false,
    value: async function filterAsync(filterfn) {
        const results = await Promise.all(this.map(filterfn));
        return this.filter((_, i) => results[i]);
    }
})

if (!Array.prototype.hasOwnProperty('findAsync')) Object.defineProperty(Array.prototype, 'findAsync', {
    configurable: false,
    enumerable: false,
    // writable: false,
    value: async function findAsync(predicate) {
