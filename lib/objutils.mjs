        ...
        if (!(key in obj)) {
            ...
            if (apply) {
                ...
                if (typeof val === "object") {
                    let newVal = val;
                    val = {};   // todo [OPEN]: check if the object will be observed (should be wrapped by the receiving decorator)
                    deepdiff(val, newVal, { cyclesFix, apply });
                }
                obj[key] = val;
            }
        }
