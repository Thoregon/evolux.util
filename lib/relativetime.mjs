...
const INTERVALS = [
    {age: 10      * 1000, interval: 10     * 1000},     // until 10 seconds ( "just now" for 10 seconds )
    {age: 30      * 1000, interval: 1      * 1000},      // until 10 seconds
    {age: 60      * 1000, interval: 5      * 1000},      // until 60 seconds
    {age: 3600    * 1000, interval: 60     * 1000},     // until 1  hour
    {age: 86400   * 1000, interval: 3600   * 1000},   // until 1  day
    {age: 2592000 * 1000, interval: 86400  * 1000},  // until 1  month
]
...
export default class RelativeTime {
    ...
    resolveInterval( age ) {
        ...
        for (let i = 0; i < INTERVALS.length; ++i) {
            ...
            if ( age < interval.age ) { return interval.interval; }
        }
        return 2592000;
    }
}
